...
const Checkout = observer(() => {
  ...
  const time =
    timeNew.getHours() +
    ":" +
    (timeNew.getMinutes() < 10 ? "0" : "") +
    timeNew.getMinutes();
  const localAddress = localStorage.getItem("address");
  const [address, setAddress] = useState(
    localAddress ? localAddress : "Казань, ул. Театральная д.3"
  );
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => res?.data && setConfig(res.data));
      ...
      if (user && user.user) {
        getAddress(user.user.id).then((e) => {
          if (e && e.data) {
            ...
            if (e.data[0]) {
              let streetId = data.rows.find(
                (street) =>
                  street.title.trim() === e.data[0].street.trim() && street
              );
              setCheckout({
                ...checkout,
                address: e.data[0],
                streetId: streetId.apiId,
              });
            }
          }
        });
  ...
  const change = (e) => {
    if (e.target.name === "address") {
      ...
      setCheckout({
        ...checkout,
        [e.target.name]: getAddressArray[e.target.value],
        streetId: streetId ? streetId.apiId : null,
      });
    } else if (e.target.name === "saveaddress") {
      setCheckout({ ...checkout, [e.target.name]: e.target.checked });
    } else if (e.target.name === "street") {
      let streetId = streets.rows.find(
        (street) => street.title === e.target.value && street
      );
      if (streetId) {
        setCheckout({
          ...checkout,
            ...
            <div className="row justify-content-center">
              <div className="col-md-7 col-lg-6 col-xl-5">
                ...
                <div className="text-center mb-4 mb-sm-5">
                  Ожидайте звонка оператора от 2 до 15 минут. Мы свяжемся с вами
                  для подтверждения заказа. Если вы не получили ответа, просим
                  позвонить по телефону +7 (843) 292-0-292 (Казань, ул.
                  Театральная д.3)
                </div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-7 col-lg-6 col-xl-5">
                ...
                <p>
                  Если в течении 5 секунд перенаправление не произошло, нажмите
                  кнопку "Перейти к форме"
                </p>
            ...
            <div className="row justify-content-center">
              <div className="col-md-7 col-lg-6 col-xl-5">
                <h3 className="text-center">
                  Мы работаем пн-вс с 10:00 до 23:00
                </h3>
                <div className="text-center mb-4 mb-sm-5">
                  Вы можете пока собрать свой заказ в корзине и когда мы
                  откроемся, оформить заказ.
                </div>
                <Link to={HOME_ROUTE} className="btn btn-2 mx-auto py-md-3">
                  В каталог
                </Link>
              ...
              <div className="row justify-content-between gx-4 gx-xl-5">
                    ...
                    <div>
                      <div className="switch fs-11 mb-4">
                        <a
                          ...
                          onClick={() =>
                            setCheckout({ ...checkout, delivery: 1 })
                          }
                        >
                          Самовывоз
                        </a>
                        <a
                          ...
                          onClick={() =>
                            setCheckout({ ...checkout, delivery: 2 })
                          }
                        >
                          Доставка
                        </a>
                        ...
                        <div className="row g-2 g-lg-3 sec-font pl-2 pr-2 pt-2">
                          ...
                          >
                            <NavDropdown.Item
                              ...
                              active={
                                address == "Казань, ул. Театральная д.3"
                                  ? true
                                  : false
                              }
                            >
                              Казань, ул. Театральная д.3
                            </NavDropdown.Item>
                          </NavDropdown>
                            ...
                            >
                              ...
                              <div className="ms-2">
                                ...
                                <div className="d-flex mt-2">
                                  <Link
                                    to={
                                      PROFILE_ROUTE + "/address/edit/" + item.id
                                    }
                ...
                <div className="col-md-5 col-xl-4 position-relative">
                  ...
                  <div className="checkout-box cart-preview">
                    <div className="mb-4">
                      <div className="title-font gray-1 fs-15 fw-6 mb-3">
                        Ваш заказ:
                      </div>
                    ...
                    <div>
                      ...
                      {cart.deliveryMinDelivery >
                        ...
                        checkout.delivery == 2 && (
                          <div className="text-secondary text-center">
                            Добавьте товаров до {cart.deliveryMinDelivery}₽ и
                      ...
                      {config?.checkout ? (
                        ...
                        <div className="text-danger text-center">
                          Временно сделать заказ невозможно. Ведутся
                          профилактические работы на сайте.
                        </div>
                      )}
                    </div>
                  </div>
